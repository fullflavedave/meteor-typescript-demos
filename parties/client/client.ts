...
// <reference path="../packages/typescript-libs/d3.d.ts" />
...
Template['map'].rendered = function () {
    ...
    if (!self.handle) {
        self.handle = Deps.autorun(function () {
            ...
            var updateCircles = function (group:D3.Transition.Transition) {
                group.attr("id", function (party) {
                    return party._id;
                })
            ...
            updateCircles(<D3.Transition.Transition>circles.enter().append("circle"));
